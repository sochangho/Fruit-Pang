...
public class RightDirMove : DirMove
{
    public RightDirMove(Nodes nodes, TileObjects tileObjects,NodeMover.Direction direction) :
    ...
    public override void EmptyMove()
    {
        ...
        for (int y = 0; y < GlobalSetting.TotalHeight; ++y)
        {
            ...
            for (int x = GlobalSetting.TotalWidth-1; x >= 0; --x)
            {
            ...
            int j = GlobalSetting.TotalWidth - 1;
    ...
    public override void RefillNode()
    {
        ...
        for (int y = 0; y < GlobalSetting.TotalHeight; ++y)
        {
            Vector2 pos = new Vector2(-intervalX, y * intervalY);
